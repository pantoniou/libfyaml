...
fy_generic config = fy_mapping(gb,
    "host", "localhost",
    "port", 8080
);
...
fy_generic server1 = fy_mapping(gb, "host", "localhost", "port", 8080);
fy_generic server2 = fy_mapping(gb, "host", "localhost", "port", 9090);
fy_generic server3 = fy_mapping(gb, "host", "localhost", "port", 3000);
