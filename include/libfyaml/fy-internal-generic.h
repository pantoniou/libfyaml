/*
 * fy-internal-generic.h - space efficient generics
 *
 * Copyright (c) 2023-2025 Pantelis Antoniou <pantelis.antoniou@konsulko.com>
 *
 * SPDX-License-Identifier: MIT
 */
#ifndef FY_INTERNAL_GENERIC_H
#define FY_INTERNAL_GENERIC_H
...
#include <libfyaml/fy-internal-align.h>
#include <libfyaml/fy-internal-endian.h>
#include <libfyaml/fy-internal-vlsize.h>
#include <libfyaml/fy-internal-atomics.h>
...
#define FYGIF_VALUE		FY_BIT(0)
#define FYGIF_ANCHOR		FY_BIT(1)
#define FYGIF_TAG		FY_BIT(2)
#define FYGIF_ALIAS		FY_BIT(3)
#define FYGIF_DIAG		FY_BIT(4)
#define FYGIF_MARKER		FY_BIT(5)
#define FYGIF_COMMENT		FY_BIT(6)

/* Shift amount of the style */
#define FYGIF_STYLE_SHIFT		5
/* Mask of the style */
#define FYGIF_STYLE_MASK		((1U << 4) - 1)
/* Build a style option */
#define FYGIF_STYLE(x)			(((unsigned int)(x) & FYGIF_STYLE_MASK) << FYGIF_STYLE_SHIFT)

/* string */
#define FYGIF_STYLE_STR_PLAIN		FYGIF_STYLE(0)
#define FYGIF_STYLE_STR_SINGLE_Q	FYGIF_STYLE(1)	// '
#define FYGIF_STYLE_STR_DOUBLE_Q	FYGIF_STYLE(2)	// "
#define FYGIF_STYLE_STR_LITERAL		FYGIF_STYLE(3)	// |
#define FYGIF_STYLE_STR_FOLDED		FYGIF_STYLE(4)	// <

/* null */
#define FYGIF_STYLE_NULL_TILDE		FYGIF_STYLE(0)	// ~
#define FYGIF_STYLE_NULL_LOWER		FYGIF_STYLE(1)	// null
#define FYGIF_STYLE_NULL_CAMEL		FYGIF_STYLE(2)	// Null
#define FYGIF_STYLE_NULL_UPPER		FYGIF_STYLE(3)	// NULL

/* bool */
#define FYGIF_STYLE_BOOL_LOWER_TF	FYGIF_STYLE(0)	// true/false
#define FYGIF_STYLE_BOOL_CAMEL_TF	FYGIF_STYLE(1)	// True/False
#define FYGIF_STYLE_BOOL_UPPER_TF	FYGIF_STYLE(2)	// TRUE/FALSE
#define FYGIF_STYLE_BOOL_LOWER_YN	FYGIF_STYLE(3)	// y/n
#define FYGIF_STYLE_BOOL_UPPER_YN	FYGIF_STYLE(4)	// Y/N
#define FYGIF_STYLE_BOOL_LOWER_ONOFF	FYGIF_STYLE(5)	// on/off
#define FYGIF_STYLE_BOOL_CAMEL_ONOFF	FYGIF_STYLE(6)	// On/Off
#define FYGIF_STYLE_BOOL_UPPER_ONOFF	FYGIF_STYLE(7)	// ON/OFF

/* int */
#define FYGIF_STYLE_INT_DECIMAL		FYGIF_STYLE(0)	// 100
#define FYGIF_STYLE_INT_HEX		FYGIF_STYLE(1)	// 0x100
#define FYGIF_STYLE_INT_OCTAL		FYGIF_STYLE(1)	// 0100
							//
/* float */
#define FYGIF_STYLE_FLOAT_REGULAR	FYGIF_STYLE(0)	// 100.0
#define FYGIF_STYLE_FLOAT_SCIENTIFIC	FYGIF_STYLE(1)	// 1E2

/* seq */
#define FYGIF_STYLE_SEQ_BLOCK		FYGIF_STYLE(0)
#define FYGIF_STYLE_SEQ_FLOW		FYGIF_STYLE(1)

/* map */
#define FYGIF_STYLE_MAP_BLOCK		FYGIF_STYLE(0)
#define FYGIF_STYLE_MAP_FLOW		FYGIF_STYLE(1)
...
/* Shift amount of the input type */
#define FYOPPF_INPUT_TYPE_SHIFT	4
/* Mask of the input type */
...
/* Shift amount of the output type */
#define FYOPEF_OUTPUT_TYPE_SHIFT	6
/* Mask of the output type */
#define FYOPEF_OUTPUT_TYPE_MASK	((1U << 4) - 1)
/* Build an output type */
...
/* Shift amount of the indent (we only support limited indent levels) */
...
/* Shift amount of the width (we only support limited widths) */
...
/* Shift amount of the style (we only support limited styles) */
 ...
 * @FYGICF_HAS_DIRECTORY: Full directory contents of vdir
