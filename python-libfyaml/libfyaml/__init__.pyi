...
class FyGeneric:
    ...
    # Metadata methods
    def get_comment(self, placement: Literal["all", "top", "right", "bottom"] = "all") -> Optional[str]: ...
    def set_comment(self, comment: Optional[str], placement: Literal["top", "right", "bottom"] = "top") -> None: ...
    def has_comment(self) -> bool: ...
    def get_document_comment(self, placement: Literal["all", "top", "bottom"] = "all") -> Optional[str]: ...
    def set_document_comment(self, comment: Optional[str], placement: Literal["top", "bottom"] = "top") -> None: ...
    def has_document_comment(self) -> bool: ...
