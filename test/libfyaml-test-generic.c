...
TCase *libfyaml_case_generic(void)
{
	...
	tcase_add_test(tc, conversion_to_int);
	tcase_add_test(tc, conversion_to_float);
	tcase_add_test(tc, conversion_to_string);
	tcase_add_test(tc, conversion_to_bool);
	tcase_add_test(tc, convert_op);

	/* generic iterator */
	tcase_add_test(tc, generic_iterator);
	tcase_add_test(tc, generic_iterator_events);
