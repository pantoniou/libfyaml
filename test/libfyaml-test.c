...
extern TCase *libfyaml_case_generic(void);
extern TCase *libfyaml_case_generic_scalars(void);
...
Suite *libfyaml_suite(void)
{
	...
	suite_add_tcase(s, libfyaml_case_generic());
	suite_add_tcase(s, libfyaml_case_generic_scalars());
